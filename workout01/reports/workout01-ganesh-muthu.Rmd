...
download.file(andre, '../data/andre-iguodala.csv')
download.file(draymond, '../data/draymond-green.csv')
download.file(kevin, '../data/kevin-durant.csv')
download.file(klay, '../data/klay-thompson.csv')
download.file(stephen, '../data/stephen-curry.csv')
```
...
png("../images/twoPoint.png", res = 100, height = nrow(twoPointEffective)*50, width = ncol(twoPointEffective)*110)
grid.table(twoPointEffective)
invisible(dev.off())
```


```{r out.width='80%', echo = FALSE, fig.align = 'center', message=FALSE, comment=""}
knitr::include_graphics('../images/twoPoint.png')
```
...
png("../images/threePoint.png", res = 100, height = nrow(threePointEffective)*50, 
    width = ncol(threePointEffective)*110)
grid.table(threePointEffective)
invisible(dev.off())
```

```{r out.width='80%', echo = FALSE, fig.align = 'center', message=FALSE, comment=""}
knitr::include_graphics('../images/threePoint.png')
```
...
```{r chart3, echo=FALSE, message = FALSE, comment=""}
shotsData = read.csv('../data/shots-data.csv', header = TRUE, sep = ",")
...
png("../images/overall.png", res = 100, height = nrow(effective)*50, width = ncol(effective)*110)
